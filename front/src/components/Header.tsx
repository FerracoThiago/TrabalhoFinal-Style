    ...
    <header className="w-full">
      ...
      <div className="block md:hidden w-full">
        ...
        <div className="w-full bg-white border-b border-gray-200 py-3 px-4 flex items-center justify-between">
          <div className="flex items-center gap-5 text-gray-700 ml-3">
          ...
          <div className="flex items-center gap-7 space-x-3 text-gray-700">
            ...
            <div className="relative">
              ...
              <span className="absolute -top-2 -right-2 bg-black text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center font-bold">2</span>
            </div>
          </div>
        </div>
      </div>
